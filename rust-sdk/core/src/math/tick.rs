...
pub fn get_tick_array_start_tick_index(tick_index: i32, tick_spacing: u16) -> i32 {
    ...
    let real_index = tick_index.div_euclid(tick_spacing_i32).div_euclid(tick_array_size_i32);
...
#[cfg_attr(feature = "wasm", wasm_expose)]
pub fn get_tick_index_in_array(tick_index: i32, tick_array_start_index: i32, tick_spacing: u16) -> Result<u32, CoreError> {
...
mod tests {
    ...
    fn test_is_full_range_only() {
        ...
        assert!(!is_full_range_only(FULL_RANGE_ONLY_TICK_SPACING_THRESHOLD - 1));
    }
